#ifndef C2014_QUEUE_MANAGER_QUEUE_MANAGER_H_
#define C2014_QUEUE_MANAGER_QUEUE_MANAGER_H_
...
#include "c2014/wpilib/queue_types.h"
...
class QueueManager {
 public:
  ...
  c2014::wpilib::WpilibOutputQueue& superstructure_output_queue();

  c2014::intakes::IntakesStatusQueue& intakes_status_queue();

  c2014::cam::CamInputQueue& cam_input_queue();
 ...
 private:
  ...
  c2014::wpilib::WpilibOutputQueue superstructure_output_queue_;

  c2014::cam::CamInputQueue cam_input_queue_;

};

}  // namespace c2014

#endif  // C2014_QUEUE_MANAGER_QUEUE_MANAGER_H_
